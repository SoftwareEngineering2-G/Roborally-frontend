...
export const PlayerProgramDisplay = ({ 
  ...
  // Convert string card names to ProgramCard objects
  const programmedCards = player.programmedCards?.map((cardName, index) => 
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 justify-start">
              {[0, 1, 2, 3, 4].map((registerIndex) => {
                const card = programmedCards[registerIndex];
                    ...
                    {hasCard ? (
                      <>
                        ...
                        <div className={cn(
                          ...
                          isRevealed ? "bg-neon-teal text-black" : "bg-gray-500 text-white"
                        )}>
                          {registerIndex + 1}
                        </div>
                      </>
