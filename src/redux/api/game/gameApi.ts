...
export const gameApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getAllGames: builder.query<GetAllGamesEndpointResponse, GetAllGamesRequest>({
      query: ({
        username,
        isPrivate,
        isFinished,
    ...
    requestGameEnd: builder.mutation<void, { gameId: string; winnerUsername: string }>({
      query: ({ gameId, winnerUsername }) => ({
